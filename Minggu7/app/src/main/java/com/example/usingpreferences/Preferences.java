...
public class Preferences {
    ...
    /** Deklarasi Edit Preferences dan mengubah data
     * yang memiliki key KEY_PASS+TEREGISTER dengan parameter password*/
    public static void setRegisteredPass(Context context, String password) {
        SharedPreferences.Editor editor = getSharedPreference(context).edit();
        editor.putString(KEY_PASS_TEREGISTER, password);
        editor.apply();
    }
    /** Mengembalikan nilai dari key KEY_PASS_TEREGIISTER berupa String */
    public static String getRegisteredPass(Context context) {
        return getSharedPreference(context).getString(KEY_PASS_TEREGISTER, "");
    }

    /** Deklarasi Edit Preferences dan mengubah data
     * yang memilki key KEY_USERNAME_SEDANG_LOGIN dengan parameter username*/
    ...
    /** Deklarasi Edit Preferences dan menghapus data, sehingga menjadikan bernilai default
     * khusus data yang memiliki key KEY_USERNAME_SEDANG_LOGIN dan KEY_STATUS_SEDAANG_LOGIN */
